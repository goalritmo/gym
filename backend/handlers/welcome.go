...
func CreateWelcomeNotificationHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = database.DB.QueryRow(
		...
		"¡Estamos emocionados de que te unas a nuestra comunidad fitness! Aquí podrás registrar tus entrenamientos, ver tu progreso y conectar con otros usuarios de la UNC. Te recomendamos explorar las Configuraciones. ¡Buen entrenamiento!",
		time.Now(),
	).Scan(&notificationID)
